...
def ShowScore2(win2, L1, L2, L3, L4, E1, E2, B1):
...
def UpdateGUI2(win2, Numbers, L1, L2, L3, L4, E1, E2, B1):
        L2.configure(text = 'The Number to convert is: ' + str(Numbers[len(Numbers) - 1]))
        print(Score2)
        print('Length', len(Numbers))
        if len(Numbers) == 11:
                ShowScore2(win2, L1, L2, L3, L4, E1, E2, B1)

def CheckAnswer2(win2, Numbers, L1, L2, L3, L4, E1, E2, B1):
        global Score2
        ...
        if len(Numbers) <= 10:
                if int(E1.get(), 2) == (Numbers[len(Numbers) - 1]) and (int(E2.get(), 16) == (Numbers[len(Numbers) - 1])):
                        ...
                        Score2 += 1
                        GetNumber2()
                        UpdateGUI2(win2, Numbers, L1, L2, L3, L4, E1, E2, B1)
                else:
                        Score2 += 0
                        GetNumber2()
                        UpdateGUI2(win2, Numbers, L1, L2, L3, L4, E1, E2, B1)
...
def DrawGUI2(Numbers):
        ...
        win2.geometry('{}x{}'.format(404, 116))
        ...
        E1 = ttk.Entry(F1)
        E2 = ttk.Entry(F1)
        B1 = ttk.Button(F1, text = 'Submit', command = lambda: CheckAnswer2(win2, Numbers, L1, L2, L3, L4, E1, E2, B1))
